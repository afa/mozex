-file("/Users/afa/.asdf/installs/erlang/27.0/lib/parsetools-2.6/include/leexinc.hrl", 0).
...
yystate(160, [113|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(136, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [108|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(116, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [105|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(100, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [104|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(72, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [99|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(40, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [98|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(135, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [85|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [83|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [82|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [81|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(160, [73|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(55, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [72|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(79, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [67|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(111, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(160, [66|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(135, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(157, [11|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(159, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(157, [12|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(159, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(157, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(159, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(157, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 14, C =< 90 ->
    yystate(159, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(157, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 92 ->
    yystate(159, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(157, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,157};
yystate(156, [105|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(155, Ics, Line, Col, Tlen, _, _) ->
    {1,Tlen,Ics,Line,Col};
yystate(154, [93|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(158, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(154, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,154};
yystate(153, [117|Ics], Line, Col, Tlen, _, _) ->
    yystate(26, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [115|Ics], Line, Col, Tlen, _, _) ->
    yystate(34, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [114|Ics], Line, Col, Tlen, _, _) ->
    yystate(149, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [113|Ics], Line, Col, Tlen, _, _) ->
    yystate(125, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [108|Ics], Line, Col, Tlen, _, _) ->
    yystate(89, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [105|Ics], Line, Col, Tlen, _, _) ->
    yystate(69, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [104|Ics], Line, Col, Tlen, _, _) ->
    yystate(37, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [99|Ics], Line, Col, Tlen, _, _) ->
    yystate(1, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [98|Ics], Line, Col, Tlen, _, _) ->
    yystate(154, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [85|Ics], Line, Col, Tlen, _, _) ->
    yystate(26, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [83|Ics], Line, Col, Tlen, _, _) ->
    yystate(34, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [82|Ics], Line, Col, Tlen, _, _) ->
    yystate(42, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [81|Ics], Line, Col, Tlen, _, _) ->
    yystate(58, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [76|Ics], Line, Col, Tlen, _, _) ->
    yystate(74, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [73|Ics], Line, Col, Tlen, _, _) ->
    yystate(86, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [72|Ics], Line, Col, Tlen, _, _) ->
    yystate(106, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [67|Ics], Line, Col, Tlen, _, _) ->
    yystate(134, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [66|Ics], Line, Col, Tlen, _, _) ->
    yystate(154, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, [47|Ics], Line, Col, Tlen, _, _) ->
    yystate(160, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(153, Ics, Line, Col, Tlen, _, _) ->
    {25,Tlen,Ics,Line,Col,153};
yystate(152, [103|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(148, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(152, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,152};
yystate(151, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(155, Ics, Line, Col, Tlen+1, 3, Tlen);
yystate(151, Ics, Line, Col, Tlen, _, _) ->
    {3,Tlen,Ics,Line,Col,151};
yystate(150, [82|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(150, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,150};
yystate(149, [105|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(145, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(149, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,149};
yystate(148, [104|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(145, [103|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(143, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(147, Ics, Line+1, 1, Tlen+1, 2, Tlen);
yystate(143, Ics, Line, Col, Tlen, _, _) ->
    {2,Tlen,Ics,Line,Col,143};
yystate(142, [84|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(146, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(142, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,142};
yystate(141, [104|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(135, [93|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(133, [93|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(122, [73|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(118, [76|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(101, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 92 ->
    yystate(97, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(101, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 94 ->
    yystate(97, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(87, [72|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(86, [78|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(74, [69|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(71, [84|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(75, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(55, [93|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(76, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(54, [84|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(133, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(50, [72|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(47, [84|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(51, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(47, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,47};
yystate(46, [71|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(34, [93|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(23, [79|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(21, [105|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(18, [93|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(12, Ics, Line, Col, Tlen, _, _) ->
    {9,Tlen,Ics,Line,Col};
yystate(11, [84|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(3, [71|Ics], Line, Col, Tlen, Action, Alen) ->
...
yyaction(19, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_19(TokenChars, TokenLine, TokenCol);
yyaction(20, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_20(TokenChars, TokenLine, TokenCol);
yyaction(21, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_21(TokenChars, TokenLine, TokenCol);
yyaction(22, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_22(TokenChars, TokenLine, TokenCol);
yyaction(23, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_23(TokenChars, TokenLine, TokenCol);
yyaction(24, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_24(TokenChars, TokenLine, TokenCol);
yyaction(25, TokenLen, YYtcs, TokenLine, TokenCol) ->
    TokenChars = yypre(YYtcs, TokenLen),
    yyaction_25(TokenChars, TokenLine, TokenCol);
...
yyaction_6(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { i_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_7/3}).
-file("src/bb_tokenize.xrl", 10).
yyaction_7(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_i_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_8/3}).
-file("src/bb_tokenize.xrl", 11).
yyaction_8(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { u_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_9/3}).
-file("src/bb_tokenize.xrl", 12).
yyaction_9(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_u_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_10/3}).
-file("src/bb_tokenize.xrl", 13).
yyaction_10(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { s_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_11/3}).
-file("src/bb_tokenize.xrl", 14).
yyaction_11(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_s_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_12/3}).
-file("src/bb_tokenize.xrl", 15).
yyaction_12(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { left_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_13/3}).
-file("src/bb_tokenize.xrl", 16).
yyaction_13(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_left_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_14/3}).
-file("src/bb_tokenize.xrl", 17).
yyaction_14(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { center_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_15/3}).
-file("src/bb_tokenize.xrl", 18).
yyaction_15(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_center_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_16/3}).
-file("src/bb_tokenize.xrl", 19).
yyaction_16(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { right_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_17/3}).
-file("src/bb_tokenize.xrl", 20).
yyaction_17(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_right_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_18/3}).
-file("src/bb_tokenize.xrl", 21).
yyaction_18(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { indent_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_19/3}).
-file("src/bb_tokenize.xrl", 22).
yyaction_19(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_indent_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_20/3}).
-file("src/bb_tokenize.xrl", 23).
yyaction_20(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { highlite_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_21/3}).
-file("src/bb_tokenize.xrl", 24).
yyaction_21(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_highlite_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_22/3}).
-file("src/bb_tokenize.xrl", 25).
yyaction_22(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { quote_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_23/3}).
-file("src/bb_tokenize.xrl", 27).
yyaction_23(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { pquote_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_24/3}).
-file("src/bb_tokenize.xrl", 28).
yyaction_24(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
     { token, { slash_quote_token, TokenLoc, TokenChars } } .

-compile({inline,yyaction_25/3}).
-file("src/bb_tokenize.xrl", 29).
yyaction_25(TokenChars, TokenLine, TokenCol) ->
    TokenLoc={TokenLine,TokenCol},
